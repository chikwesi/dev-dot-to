export const LISTING_DATA = {
    ...
    items: [
        {
            title: "Slick Website Template",
            category: "mentors"
        },
        {
            title: "FREE Clean Code and Refactoring Collaborative  Sessio",
            category: "mentors"
        }, {
            title: "FREE Clean Code and Refactoring Collaborative  Sessio",
            category: "mentors"
...
export const SOCIAL_LINKS = [
    {
        name: "twitter",
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a4qnb7xhoj16k1ucwdakskl2ccxdfolq" ><title id="a4qnb7xhoj16k1ucwdakskl2ccxdfolq">Twitter</title>
            <path d="M22.162 5.656a8.383 8.383 0 01-2.402.658A4.196 4.196 0 0021.6 4c-.82.488-1.719.83-2.656 1.015a4.182 4.182 0 00-7.126 3.814 11.874 11.874 0 01-8.62-4.37 4.168 4.168 0 00-.566 2.103c0 1.45.738 2.731 1.86 3.481a4.168 4.168 0 01-1.894-.523v.052a4.185 4.185 0 003.355 4.101 4.211 4.211 0 01-1.89.072A4.185 4.185 0 007.97 16.65a8.395 8.395 0 01-6.191 1.732 11.83 11.83 0 006.41 1.88c7.693 0 11.9-6.373 11.9-11.9 0-.18-.005-.362-.013-.54a8.495 8.495 0 002.087-2.165l-.001-.001z" fill="#000"></path>
        </svg>
    },
    {
        name: "facebook",
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="aj40bic1buzzr5fxhjj6crgmnfu4hz8g" ><title id="aj40bic1buzzr5fxhjj6crgmnfu4hz8g">Facebook</title>
            <path d="M15.402 21v-6.966h2.333l.349-2.708h-2.682V9.598c0-.784.218-1.319 1.342-1.319h1.434V5.857a19.188 19.188 0 00-2.09-.107c-2.067 0-3.482 1.262-3.482 3.58v1.996h-2.338v2.708h2.338V21H4a1 1 0 01-1-1V4a1 1 0 011-1h16a1 1 0 011 1v16a1 1 0 01-1 1h-4.598z"></path>
        </svg>
    },
    {
        name: "git-hub",
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="aqgar9k4kgbdohkpbq0fleb0dnkki4fk" ><title id="aqgar9k4kgbdohkpbq0fleb0dnkki4fk">Github</title>
    ...
    {
        name: "instagram",
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="aen3ww4glol837x7gorxafi3kgpffkd2"><title id="aen3ww4glol837x7gorxafi3kgpffkd2">Instagram</title>
    ...
    {
        name: "twitch",
        icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="aaj1huonq5v47q3lg3a5hrt4f2lf5loo" ><title id="aaj1huonq5v47q3lg3a5hrt4f2lf5loo">Twitch</title>
